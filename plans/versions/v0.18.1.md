...
- [ ] Query templates (select-all, join-two, group-count, order-limit)
- [ ] Error prevention (syntax error highlighting, typo suggestions, ambiguous column warnings, table validation, missing JOIN condition checks)
