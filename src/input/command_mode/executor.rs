...
///   :bgcolor C red > 100              - column C, conditional
///   :bgcolor C red (> 100 && < 200) || = 0  - column C, grouped
///   :bgcolor 1 red                    - row 1, flat color
///   :bgcolor C clear                  - remove all rules for column/row
